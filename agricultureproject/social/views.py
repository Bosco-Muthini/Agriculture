...
from animals.models import Cattle
...
from .forms import UserprofileForm, PostForm, CommentForm, ShareForm, ThreadForm, MessageForm
...
class UserSearch(View):
    def get(self, request, *args, **kwargs):
        ...
        domestic_list=Cattle.objects.filter(
